      ...
      <Grid item container alignItems={"center"} xs={12} md={6}>
        <Box data-aos={isMd ? "fade-right" : "fade-up"}>
          ...
          <Grid container spacing={1}>
            {["Lifetime updates & introduction and working", "Tech support & mutual funds", "Tons of assets & lifetime updates", "Integration ready & tech support"].map((item, i) => (
            ...
            <Box>
              ...
              <Box
                ...
                <Box
                  ...
                  src={theme.palette.mode === "light" ? "https://assets.maccarianagency.com/screenshots/crypto-mobile.png" : "https://assets.maccarianagency.com/screenshots/crypto-mobile--dark.png"}
