...
const Hero = () => {
  ...
  return (
    <Box
      ...
      <Container zIndex={3} position={"relative"} minHeight={{ xs: 300, sm: 400, md: 600 }} maxHeight={600} display={"flex"} alignItems={"center"} justifyContent={"center"}>
        <Box width={1}>
          <Box marginBottom={2}>
            <Typography
              variant="h2"
          ...
          <Box>
            <Typography
              ...
              What I did and what I am good at.
            </Typography>
          </Box>
        </Box>
      </Container>
